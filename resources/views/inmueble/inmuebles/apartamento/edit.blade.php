...
<form method="POST" action="/apartamentos/{{ $inmueble->id }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="numeric" name="baños" class="form-control" id="baños" placeholder="baños..." value="{{ $inmueble->baños }}" required>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="numeric" name="habitaciones" class="form-control" id="habitaciones" placeholder="habitaciones..." value="{{ $inmueble->habitaciones }}" required>
            </div>
        </div>
        {{-- <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="numeric" name="pisos" class="form-control" id="pisos" placeholder="pisos..." value="{{ $inmueble->pisos }}">
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
